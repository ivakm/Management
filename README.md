...
**Stack:** Node 22.12.0 · express 4.18.2 · Angular 19.2
...
| `developer` | Full-stack Node + Angular features                                           | sonnet | +      | Context7, Figma, IDE, Agent |
...
| `node-refactoring-expert` | Refactoring, N+1 fixes, code quality                                          | sonnet | +      | — |
