...
import { DashboardStats, MonthlyRevenue, CustomerDistribution, RecentActivity, TopCustomer, DashboardData } from '../models';
...
export class DashboardService {
  ...
  getDistribution(): Observable<{ success: boolean; data: CustomerDistribution[] }> {
    return this.api.get<{ success: boolean; data: CustomerDistribution[] }>('/dashboard/distribution');
  }
